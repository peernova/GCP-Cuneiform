...
export YML_DIR=/tmp 
export IMAGE_MW_ANALYTICS=`grep IMAGE_MW_ANALYTICS: /data/final_values.yaml|sed 's/IMAGE_MW_ANALYTICS: \(.*\)/\1/g'`
export IMAGE_FE_PLATFORM=`grep IMAGE_FE_PLATFORM: /data/final_values.yaml|sed 's/IMAGE_FE_PLATFORM: \(.*\)/\1/g'`
external_replace.sh 
